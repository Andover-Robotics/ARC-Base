...
public class WobbleClaw extends SubsystemBase {
  ...
  public static int
      armUpPos = 0, armDownPos = 350, armDropPos = 300, rotationMaxTicksPerIteration = 4;//TODO: test values
  ...
  public WobbleClaw(OpMode opMode) {
    ...
    // last: 32
    armRotator.setVelocityPIDFCoefficients(30, 1.5, 1.2, 1);
...
//    }
    ...
    if(armRotator.getTargetPosition() == 0 && !armRotator.isBusy()){
