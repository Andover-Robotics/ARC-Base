...
//        .build());
    bot.roadRunner.followTrajectory(bot.roadRunner.trajectoryBuilder(paths.getStartPose())
        .lineToSplineHeading(paths.getStartPowerShotPose())
        .build());

    bot.roadRunner.setWeightedDrivePower(new Pose2d(0, -0.42, 0.0));
    bot.shooter.shootRings(this, 3, 0.59);
