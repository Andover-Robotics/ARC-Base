...
public class MaxVelocityTuner extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    telemetry
        .addData("Voltage Compensated kF", effectiveKf * batteryVoltageSensor.getVoltage() / 12);
    telemetry.update();
  ...
  private double veloInchesToTicks(double inchesPerSec) {
    return inchesPerSec / (2 * Math.PI * DriveConstants.WHEEL_RADIUS) / DriveConstants.GEAR_RATIO
